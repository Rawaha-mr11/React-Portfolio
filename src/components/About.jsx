    ...
    <>
      ...
      >
        <div className="w-full lg:w-[95%] xl:w-[85%] flex flex-col lg:flex-row flex-wrap items-center justify-center lg:justify-evenly gap-8 lg:gap-4">
          ...
          <div className="w-full sm:w-4/5 md:w-3/5 lg:w-2/5 xl:w-2/5 p-4 sm:p-6 lg:p-8 xl:p-10 border-[1px] border-card">
          ...
          {/* Content Section */}
          <div className="w-full lg:w-2/4 xl:w-2/4 flex flex-col flex-wrap">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-between sm:justify-evenly mt-6 sm:mt-8 lg:mt-9 sm:gap-0">
              ...
              <div className="text-text-secondary text-base sm:text-lg font-[500] leading-8 sm:leading-10">
                ...
                <li>React Products Development</li>
                <li>Tailwind Development</li>
              </div>
            </div>
          </div>
        </div>
